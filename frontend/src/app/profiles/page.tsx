    ...
    <div className="min-h-screen bg-white dark:bg-black text-black dark:text-white px-4 py-8 transition-colors duration-300">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        {filteredUsers.slice(0, visibleCount).map((user) => (
          <div 
            key={user.id}
            className="group relative bg-gray-100 dark:bg-gray-900 rounded-lg overflow-hidden shadow-md border border-gray-300 dark:border-gray-700 transition-all p-4 h-full hover:shadow-lg hover:border-indigo-500"
          >
            <Link href={`/profiles/${encodeURIComponent(user.id)}`} className="absolute inset-0 z-10" />
